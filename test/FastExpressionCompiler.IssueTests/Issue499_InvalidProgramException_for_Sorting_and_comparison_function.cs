...
public struct Issue499_InvalidProgramException_for_Sorting_and_comparison_function : ITestX
{
    public void Run(TestRun t)
    {
        ...
        ArrayInList_ArrayAcceesError_NullableInt(t);
        ArrayInList_ArrayAcceesError_Int(t);
        ArrayInList_ArrayAcceesError_String(t);
        ArrayInList_ArrayAcceesError_Struct(t);
    }
    ...
    /// </summary>
    /// <param name="t"></param>
    public void ArrayInList_ArrayAcceesError_NullableInt(TestContext t)
    {
    ...
    /// </summary>
    /// <param name="t"></param>
    public void ArrayInList_ArrayAcceesError_Int(TestContext t)
    {
        List<Expression> exps = new List<Expression>();
        var dataArrayList = Parameter(typeof(List<int[]>), "dataArrayList");
        List<ParameterExpression> vars = new List<ParameterExpression>();
    ...
    /// </summary>
    /// <param name="t"></param>
    public void ArrayInList_ArrayAcceesError_String(TestContext t)
    {
        List<Expression> exps = new List<Expression>();
    ...
    /// </summary>
    /// <param name="t"></param>
    public void ArrayInList_ArrayAcceesError_Struct(TestContext t)
    {
        List<Expression> exps = new List<Expression>();
        var dataArrayList = Parameter(typeof(List<TmpStruct[]>), "dataArrayList");
        List<ParameterExpression> vars = new List<ParameterExpression>();
        var left_ListIndex = Parameter(typeof(int), "left_ListIndex");
        var left_ArrayIndex = Parameter(typeof(int), "left_ArrayIndex");
        ...
        var expr = Lambda<Func<List<TmpStruct[]>, int?>>(block, dataArrayList);
        expr.PrintCSharp();

        List<TmpStruct[]> data1 = new List<TmpStruct[]> { new TmpStruct[] { new TmpStruct { Foo = 1 } } };
        List<TmpStruct[]> data2 = new List<TmpStruct[]> { new TmpStruct[] { new TmpStruct { Foo = 1 } } };
